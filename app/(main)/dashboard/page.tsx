    ...
    <div className="max-w-6xl mx-auto space-y-8 py-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="self-start sm:self-auto flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-semibold bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700/60 shadow-sm transition-all"
        >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Streak */}
        <div className="glass-panel p-5 rounded-3xl border border-slate-200 dark:border-slate-800 flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white">
              {analytics?.streakDays || 1} <span className="text-xs font-medium text-slate-400">days</span>
            </h3>
          </div>
        </div>
