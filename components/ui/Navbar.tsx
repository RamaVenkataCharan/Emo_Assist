        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-teal-400 flex items-center justify-center shadow-lg shadow-indigo-500/20 group-hover:scale-105 group-hover:rotate-3 transition-transform duration-200">
                <HeartHandshake className="w-5 h-5 text-white" />
              </div>
              <div>
                <span className="text-lg font-extrabold bg-gradient-to-r from-indigo-600 via-purple-600 to-teal-500 dark:from-indigo-400 dark:via-purple-300 dark:to-teal-300 bg-clip-text text-transparent">
                  EMO Assistant
                </span>
                <span className="hidden sm:inline-block ml-2 text-[10px] uppercase tracking-wider font-bold px-2.5 py-0.5 rounded-full bg-teal-500/10 text-teal-600 dark:text-teal-400 border border-teal-500/20 shadow-sm">
                  Mindful 3D
                </span>
              </div>
            </Link>
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                      isActive
                        ? "bg-indigo-500/15 text-indigo-600 dark:text-indigo-300 font-bold shadow-sm border border-indigo-500/30 glow-primary"
            ...
            <div className="hidden md:flex items-center gap-3">
              {/* 3D Mindful Breath Launcher */}
              <button
                onClick={openBreathing}
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-bold text-teal-600 dark:text-teal-300 bg-teal-500/10 hover:bg-teal-500/20 border border-teal-500/30 hover:border-teal-500/50 shadow-sm transition-all duration-200 active:scale-95"
                title="Launch 3D Mindful Breathing Sanctuary"
              >
              ...
              <div className="flex items-center gap-2 pl-2 border-l border-slate-200 dark:border-slate-800">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500/30 to-teal-500/30 border border-indigo-500/40 flex items-center justify-center text-sm shadow-sm">
                  🌸
                </div>
            ...
            <div className="flex md:hidden items-center gap-2">
              <button
                onClick={openBreathing}
                className="p-2 rounded-xl bg-teal-500/10 text-teal-600 dark:text-teal-400 border border-teal-500/20"
                aria-label="3D Breath"
                title="3D Breath"
              >
              ...
              <button
                onClick={() => setCrisisModalOpen(true)}
                className="p-2 rounded-xl bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 border border-rose-200 dark:border-rose-800/60"
          ...
          <div className="md:hidden border-t border-slate-200 dark:border-slate-800/80 px-4 pt-2 pb-4 space-y-1 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md">
            ...
            <div className="pt-2 space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-teal-600 dark:text-teal-300 bg-teal-500/10 border border-teal-500/30"
              >
                <Wind className="w-4 h-4 text-teal-400" />
                Launch 3D Mindful Breath Sanctuary
              </button>
              <button
                onClick={() => {
                  setMobileMenuOpen(false);
